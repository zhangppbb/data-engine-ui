<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column align="center" label="字典类别" prop="category">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_DICT_CATEGORY" :value="scope.row.category" />
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          ...
          <router-link :to="'/dict/type/data/' + scope.row.type + '/' + scope.row.category">
