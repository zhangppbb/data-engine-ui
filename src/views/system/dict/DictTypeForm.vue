  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="类别" prop="category">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.category" :disabled="typeof formData.id !== 'undefined'">
          <el-radio
            v-for="dict in getIntDictOptions(DICT_TYPE.SYSTEM_DICT_CATEGORY)"
            :key="dict.value"
            :value="dict.value"
          >
            {{ dict.label }}
...
const formData = ref({
  ...
  category: SystemDictCategoryEnum.LIST,
  remark: ''
})
