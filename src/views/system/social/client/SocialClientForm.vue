  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="社交平台" prop="socialType">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.socialType">
          <el-radio
      ...
      <el-form-item label="用户类型" prop="userType">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.userType">
          <el-radio
