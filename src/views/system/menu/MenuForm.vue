  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="菜单类型" prop="type">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.type">
          <el-radio-button
      ...
      <el-form-item v-if="formData.type !== 3" label="显示状态" prop="visible">
        ...
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.visible">
      ...
      <el-form-item v-if="formData.type !== 3" label="总是显示" prop="alwaysShow">
        ...
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.alwaysShow">
      ...
      <el-form-item v-if="formData.type === 2" label="缓存状态" prop="keepAlive">
        ...
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="formData.keepAlive">
