<template>
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          ...
          <el-button
            ...
            v-hasPermi="['system:post:assign-post-user']"
          >
            分配用户
          </el-button>
          <el-button
  ...
  <!-- 表单弹窗：分配用户 -->
  <PostUserForm ref="postUserFormRef" @success="getList" />
</template>
...
import PostUserForm from './PostUserForm.vue'
...
/** 分配用户 */
const postUserFormRef = ref()
const openUser = (row: PostApi.PostVO) => {
  postUserFormRef.value.open(row)
}
