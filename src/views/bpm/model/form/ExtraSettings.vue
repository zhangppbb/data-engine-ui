  ...
  <el-form ref="formRef" :model="modelData" label-width="120px" class="mt-20px">
    ...
    <el-form-item class="mb-20px">
      ...
      <div class="flex flex-col">
        ...
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="modelData.autoApprovalType">
          <div class="flex flex-col">
    ...
    <el-form-item v-if="modelData.titleSetting" class="mb-20px">
      ...
      <div class="flex flex-col">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="modelData.titleSetting.enable">
          <div class="flex flex-col">
    ...
    >
      ...
      <div class="flex flex-col">
        <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="modelData.summarySetting.enable">
          <div class="flex flex-col">
            <el-radio :value="false">
