<template>
  ...
  >
    ...
    <div v-if="currentNode.type === NodeType.USER_TASK_NODE" class="flex flex-items-center mb-3">
      ...
      <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="approveType">
        <el-radio
        ...
        <div>
          <el-form ref="formRef" :model="configForm" label-position="top" :rules="formRules">
            ...
            <el-form-item :label="`多人${nodeTypeName}方式`" prop="approveMethod">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.approveMethod" @change="approveMethodChanged">
                <div class="flex-col">
                  <div
            ...
            <div v-if="currentNode.type === NodeType.USER_TASK_NODE">
              ...
              <el-form-item prop="rejectHandlerType">
                <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.rejectHandlerType">
                  <div class="flex-col">
            ...
            <el-form-item prop="assignEmptyHandlerType">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.assignEmptyHandlerType">
                <div class="flex-col">
            ...
            <div v-if="currentNode.type === NodeType.USER_TASK_NODE">
              ...
              <el-form-item prop="assignStartUserHandlerType">
                <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.assignStartUserHandlerType">
                  <div class="flex-col">
      ...
      <el-tab-pane label="表单字段权限" name="fields" v-if="formType === 10">
        <div class="field-setting-pane">
          ...
          >
            ...
            <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" class="field-setting-item-group" v-model="item.permission">
