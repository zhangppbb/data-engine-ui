        ...
        <div>
          <el-form ref="formRef" :model="configForm" label-position="top" :rules="formRules">
            ...
            <el-form-item label="子流程发起人" prop="startUserType">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.startUserType">
                <el-radio
            ...
            <el-form-item
              ...
              prop="startUserType"
            >
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.startUserEmptyType">
                <el-radio
            ...
            <div v-if="configForm.timeoutEnable">
              <el-form-item prop="timeoutType">
                <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="configForm.timeoutType">
                  <el-radio-button
