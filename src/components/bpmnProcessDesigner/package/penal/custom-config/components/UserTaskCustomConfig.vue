...
<template>
  <div>
    ...
    <el-form-item prop="approveType">
      <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="approveType.value">
        <el-radio
    ...
    <el-form-item prop="assignEmptyHandlerType">
      <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="assignEmptyHandlerType" @change="updateAssignEmptyHandlerType">
        <div class="flex-col">
    ...
    <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="assignStartUserHandlerType" @change="updateAssignStartUserHandlerType">
      <div class="flex-col">
