    ...
    <div class="sc-cron">
      <el-tabs>
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.second.type">
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.minute.type">
                <el-radio-button value="0">任意值</el-radio-button>
                <el-radio-button value="1">范围</el-radio-button>
                <el-radio-button value="2">间隔</el-radio-button>
                <el-radio-button value="3">指定</el-radio-button>
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.hour.type">
                <el-radio-button value="0">任意值</el-radio-button>
                <el-radio-button value="1">范围</el-radio-button>
                <el-radio-button value="2">间隔</el-radio-button>
                <el-radio-button value="3">指定</el-radio-button>
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.day.type">
                <el-radio-button value="0">任意值</el-radio-button>
                <el-radio-button value="1">范围</el-radio-button>
                <el-radio-button value="2">间隔</el-radio-button>
                <el-radio-button value="3">指定</el-radio-button>
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.month.type">
                <el-radio-button value="0">任意值</el-radio-button>
                <el-radio-button value="1">范围</el-radio-button>
                <el-radio-button value="2">间隔</el-radio-button>
                <el-radio-button value="3">指定</el-radio-button>
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form>
              <el-form-item label="类型">
                <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.week.type">
                  <el-radio-button value="0">任意值</el-radio-button>
                  <el-radio-button value="1">范围</el-radio-button>
                  <el-radio-button value="2">间隔</el-radio-button>
                  <el-radio-button value="3">指定</el-radio-button>
        ...
        <el-tab-pane>
          ...
          <el-form>
            <el-form-item label="类型">
              <el-radio-group style="--el-text-color-regular: #666;--el-fill-color-blank: #fff;" v-model="cronValue.year.type">
