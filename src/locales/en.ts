export default {
  common: {
    ...
    exportNoData: 'Please select the data to export',
    delSuccess: 'Deleted successfully',
    showNoData: 'The accessed data does not exist, please try refreshing the page',
    createOne: 'Only one data can be created',
    index: 'Index',
    status: 'Status',
